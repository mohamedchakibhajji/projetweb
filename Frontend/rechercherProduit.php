					...
					<div class="flex-sb-m flex-w p-b-35">
						<div class="flex-w">
                            ...
                            <div class="form-actions">
                                          <button  type="submit"  name="Rechercher" value="Rechercher" class="btn">Search</button>
                                        </div>
						</div>
                         </form>
...
if (isset($_POST['rechercher']) and ($_POST["sorting"]== "Price: low to high")){
	$listeProduit=$produitP->trierProduit();
}
?>                  
