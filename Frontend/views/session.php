...
<script>
	alert("Bienvenue Chez Casa Sport");
</script>
<!DOCTYPE html>
<html lang="en">
<head>
...
<!--===============================================================================================-->
	<link rel="icon" type="image/png" href="images/icons/logo_casa_sport.png"/>
<!--===============================================================================================-->
					...
					<div class="header-wrapicon2">
						...
						<div class="header-cart header-dropdown">
							<ul class="header-cart-wrapitem">
								<h3 style="text-align: center;">Carte de fidelité</h3>
								<br>
								<form method="POST" action="ajoutfidele.php">
								<li class="header-cart-item">

										<div class="bo4 of-hidden size15 m-b-20">
											<input class="sizefull s-text7 p-l-22 p-r-22" type="text" name="id" id="id" placeholder="Identfiant">
										</div>
								...
								<li class="header-cart-item">
										...
										<div class="bo4 of-hidden size15 m-b-20">
											<input class="sizefull s-text7 p-l-22 p-r-22" type="password" name="pwd" id="pwd" placeholder="Password">
										</div>
							...
							<div class="header-cart-buttons">
								<div class="header-cart-wrapbtn">
									<input type="submit" value="Submit" class="flex-c-m size1 bg1 bo-rad-20 hov1 s-text1 trans-0-4">
								</div>
								</form>
...
<!--clients  -->
					...
					<div class="header-wrapicon2">
						...
						<div class="header-cart header-dropdown">
							<ul class="header-cart-wrapitem">
								...
								<p style="text-align: center;"><?PHP echo $mail; ?></p>
								<br>
							...
							<div class="header-cart-buttons">
								<div class="header-cart-wrapbtn">
									<!-- Button -->
									<a href="index.php" class="flex-c-m size1 bg1 bo-rad-20 hov1 s-text1 trans-0-4">Logout</a>
								</div>

								<div class="header-cart-wrapbtn">
									<!-- Button -->
									<a href="Modify.php" class="flex-c-m size1 bg1 bo-rad-20 hov1 s-text1 trans-0-4">
										Mon compte
									</a>
								</div>
	...
	<section class="slide1">
		<div class="wrap-slick1">
			<div class="slick1">
				<div class="item-slick1 item1-slick1" style="background-image: url(images/chaussures-adidas-cloudfoam-lite-racer-gris-pour-homme.jpg);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
						<span class="caption1-slide1 m-text1 t-center animated visible-false m-b-15" data-appear="fadeInDown">
							CHAUSSURES ADIDAS CLOUDFOAM LITE RACER Homme
						</span>
				...
				<div class="item-slick1 item2-slick1" style="background-image: url(images/s-l1600.jpg);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
						<span class="caption1-slide1 m-text1 t-center animated visible-false m-b-15" data-appear="rollIn">
							survêtements GIVOVA Homme
						</span>
				...
				<div class="item-slick1 item3-slick1" style="background-image: url(images/veste-givova-olanda.jpg);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
		...
		<div class="flex-w p-b-90">
			...
			<div class="w-size7 p-t-30 p-l-15 p-r-15 respon4">
				...
				<ul>
					...
					<li class="p-b-9">
						<a href="marque.html" class="s-text7">
							Nos marques
						</a>
					</li>
