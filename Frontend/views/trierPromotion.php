        ...
        <div class="container-fluid">
            <div class="row-fluid">
                <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        ...
                        <li >
                         ...
                         <li class="active">
                            <a href="../produit1.php"><span class="badge badge-success pull-right">731</span> Promotion</a>
                        </li>
               ...
               <div class="control-group">
                <form method="GET" action="rechercherPromotion.php">
                        ...
                        <!--block -->
                                         <div class="control-group">
                <form method="GET" action="trierPromotion.php">
                                          <div class="controls">
                                            <button type="submit" class="btn btn-large btn-block">Trier Le Tableau Promotion</button>
                                          </div>
                </form>
...
$listePromotion=$Promotion1P->trierPromotion();
