			...
			<div class="w-size14 p-t-30 respon5">
				...
				<div class="p-t-33 p-b-60">
					<div class="rs2-select2 rs3-select2 bo4 of-hidden w-size16">
							<select class="selection-2" name="Nomproduit">
					...
					<input class="size8 m-text18 t-center num-product" type="number" name="id_commande" value="1">
					...
					<div class="flex-m flex-w">
						...
						<div class="rs2-select2 rs3-select2 bo4 of-hidden w-size16">
							<select class="selection-2" name="couleur">
								<option>Choose an option</option>
								<option>Gray</option>
								<option>Red</option>
								<option>Black</option>
...
?>
								<a herf="../front/cart.html"<td><input type="submit" name="ajouter" value="ajouter"></td></a>
