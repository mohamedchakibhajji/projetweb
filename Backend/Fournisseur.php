...
<html class="no-js">
  ...
  function notify() {
    var notification = new Notification('Fournisseur', {
      icon: 'icon.ico',
      body: "Fournisseur supprimé avec succé!",
                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <button type="button" class="close" data-dismiss="alert">×</button>
                            <h4>Erreur</h4>
                            Veuillez insérer les données correctement</div>';
                                    }
                                    ?>
...
?>							 
									...
									<div class="control-group">
                                        ...
                                        <div class="control-group">
                                          ...
                                          <div class="controls">
                                            <input type="number" min=0 class="span6" id="telephone" name="telephone"  >
											...
											<label class="control-label">Note<span class="required">*</span></label>
												<div class="controls">
													<input name="note" min=1 type="number" class="span6 m-wrap" id="note" />
													<div class="error-message">erreur</div>
												</div>
											</div>
